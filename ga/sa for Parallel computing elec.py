...
@jit
def loop1():
    file = open("C:/Users/a1999/Desktop/實驗/SA/sa.txt", "w")
    for picture in range(1,11):
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/SA/R{}.png'.format(picture))
        plt.close()
...
@jit
def loop2():
    file = open("C:/Users/a1999/Desktop/實驗/SA/sa2.txt", "w")
    for picture in range(1,11):
        T = 1
        R = 0.95
        while 1:
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/SA/R{}.png'.format(picture+10))
        plt.close()
        file.write(f"{best} {bestvalue} {bestcost} {bestkind}\n")
    file.close()
    return
@jit
def loop3():
    file = open("C:/Users/a1999/Desktop/實驗/SA/sa3.txt", "w")
    for picture in range(1,11):
        T = 1
        R = 0.95
        while 1:
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/SA/R{}.png'.format(picture+20))
        plt.close()
        file.write(f"{best} {bestvalue} {bestcost} {bestkind}\n")
    file.close()
    return
