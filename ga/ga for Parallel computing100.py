...
def evaluate_chromosome(fitnesslist, costlist, budget):
    ...
    for i, j in enumerate(fitnesslist):
        ...
        if sum(fitnesslist) == 0:
            fitness = 0.01**((cost/budget)**0.5)
...
@jit
def loop1():
    file = open("C:/Users/a1999/Desktop/實驗/GA100/ga.txt", "w")
    for picture in range(1,11):
        ...
        draw.sort()
        plt.plot(time,draw,color='red',label="GA100")
        plt.ylim(0,1.2)
        plt.legend()
...
@jit
def loop2():
    file = open("C:/Users/a1999/Desktop/實驗/GA100/ga2.txt", "w")
    for picture in range(1,11):
        pop = []
        end=0
        start=perf_counter()
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/GA100/R{}.png'.format(picture+10))
        plt.close()
        file.write(f"{bestsolution} {len(bestfitness)}\n")
        print(bestsolution,len(bestfitness))
    file.close()
...
@jit
def loop3():
    file = open("C:/Users/a1999/Desktop/實驗/GA100/ga3.txt", "w")
    for picture in range(1,11):
        pop = []
        end=0
        start=perf_counter()
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/GA100/R{}.png'.format(picture+20))
        plt.close()
        file.write(f"{bestsolution} {len(bestfitness)}\n")
        print(bestsolution,len(bestfitness))
    file.close()
