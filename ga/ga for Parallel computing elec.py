...
@jit
def loop1():
    file = open("C:/Users/a1999/Desktop/實驗/GA/ga.txt", "w")
    for picture in range(1,11):
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/GA/R{}.png'.format(picture))
        plt.close() 
...
@jit
def loop2():
    file = open("C:/Users/a1999/Desktop/實驗/GA/ga2.txt", "w")
    for picture in range(1,11):
        pop = []
        end=0
        start=perf_counter()
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/GA/R{}.png'.format(picture+10))
        plt.close()
        file.write(f"{bestsolution} {len(bestfitness)}\n")
        print(bestsolution,len(bestfitness))
    file.close()
...
@jit
def loop3():
    file = open("C:/Users/a1999/Desktop/實驗/GA/ga3.txt", "w")
    for picture in range(1,11):
        pop = []
        end=0
        start=perf_counter()
        ...
        plt.ylim(0,1.2)
        plt.legend()
        plt.savefig('C:/Users/a1999/Desktop/實驗/GA/R{}.png'.format(picture+20))
        plt.close()
        file.write(f"{bestsolution} {len(bestfitness)}\n")
        print(bestsolution,len(bestfitness))
    file.close()
